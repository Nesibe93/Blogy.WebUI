...
namespace Blogy.WebUI.Areas.Writer.Models
{
    public class WeatherViewModel
    {
        ...
        public class Current
        {
            ...
            public float temp_c { get; set; } // intti float yaptım
            public float temp_f { get; set; }// intti float yaptım
            ...
            public float pressure_mb { get; set; }// intti float yaptım
            public float pressure_in { get; set; }// intti float yaptım
            public float precip_mm { get; set; }// intti float yaptım
            public float precip_in { get; set; }// intti float yaptım
            public int humidity { get; set; }
            public int cloud { get; set; }
            public float feelslike_c { get; set; }// intti float yaptım
            public float feelslike_f { get; set; }// intti float yaptım
            public float vis_km { get; set; }// intti float yaptım
            public float vis_miles { get; set; }// intti float yaptım
            public float uv { get; set; }// intti float yaptım
        ...
        public class Day
        {
            ...
            public float totalsnow_cm { get; set; } //intti float yaptım
            public float avgvis_km { get; set; }
            public float avgvis_miles { get; set; }//intti float yaptım
